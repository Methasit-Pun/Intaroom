      ...
      <div className="w-full max-w-md p-8 rounded-3xl bg-[#6D3B3B]">
        ...
        {/* <div className="mb-6">
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 w-full px-4 py-3 rounded-xl bg-white hover:bg-gray-50 text-gray-700 font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98]"
          >
